...
import 'package:spoton/views/addPhaseScopeScreen2.dart';
import 'package:spoton/views/addPhaseScreen3.dart';

class addPhaseScreen2 extends StatefulWidget {
  const addPhaseScreen2(
  ...
  @override
  State<addPhaseScreen2> createState() => _addPhaseScreen2State();
}

class _addPhaseScreen2State extends State<addPhaseScreen2> {
  String? token;
  ...
  loadSharedPreferences() async {
    ...
    phaseController.fetchProjectDetails(
        widget.id.toString(), widget.cardId.toString(), token);
  }
              ...
              Obx(
                () => phaseController.isLoading.value
                    ...
                    : ListView.builder(
                        ...
                        itemCount:
                            phaseController.regionDetails.value!.data.length,
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            child: ListTile(
                              title: Text(
                                phaseController.regionDetails.value!.data[index]
                                    .regionName,
                                style: TextStyle(
                                  fontFamily: "Roboto",
                                  fontSize: 17 * fem,
