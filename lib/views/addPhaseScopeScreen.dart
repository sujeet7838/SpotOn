...
class addPhaseScopeScreen extends StatefulWidget {
  const addPhaseScopeScreen(
      {super.key, required this.name, required this.id, required this.token, required this.cardId});
  ...
  @override
  State<addPhaseScopeScreen> createState() => _addPhaseScopeScreenState();
}

class _addPhaseScopeScreenState extends State<addPhaseScopeScreen> {
  final PhaseController phaseController = Get.put(PhaseController());

  @override
  void initState() {
    super.initState();
    phaseController.fetchScopeDetails(widget.token);
  }
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return Container(
                            ...
                            child: ListTile(
                              title: Text(
                                phaseController.scopeList.value!.data[index].scopeEntity,
                                style: TextStyle(
                                  fontFamily: "Roboto",
                                  fontSize: 17 * fem,
                                  fontWeight: FontWeight.w500,
