...
class addPhaseScopeScreen3 extends StatefulWidget {
  const addPhaseScopeScreen3({super.key, required this.name, required this.id});

  final String name;
  final int id;

  @override
  State<addPhaseScopeScreen3> createState() => _addPhaseScopeScreen3State();
}

class _addPhaseScopeScreen3State extends State<addPhaseScopeScreen3> {
