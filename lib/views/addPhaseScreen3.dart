...
import 'package:spoton/views/addPhaseScopeScreen3.dart';
import 'package:spoton/views/projectDashboardScreen.dart';


class addPhaseScreen3 extends StatefulWidget {
  const addPhaseScreen3({super.key, required this.name, required this.id, required this.cardId});
  ...
  @override
  State<addPhaseScreen3> createState() => _addPhaseScreen3State();
}

class _addPhaseScreen3State extends State<addPhaseScreen3> {
